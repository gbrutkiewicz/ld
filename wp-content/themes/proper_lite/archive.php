    	...
    	<div class="grid grid-pad overflow">
        	<div class="col-1-1">
            	<div class="animated fadeInUp delay">
					<?php
					properlite_the_archive_title( '<h1 class="entry-title">', '</h1>' );
					properlite_the_archive_description( '<div class="taxonomy-description">', '</div>' );
				?>
                </div><!-- .animated -->
            </div><!-- .col-1-1 -->
        </div><!-- .grid -->
...
<section id="archive-content-container" class="animated fadeIn delay-2">    
	<div id="primary" class="content-area">
		...
		<?php if ( have_posts() ) : ?>
			...
			<?php properlite_the_posts_navigation(); ?>
