...
function properlite_home_widget_one_style() {

	$widget_column_one = esc_html( get_theme_mod( 'properlite_widget_column_one' ));
...
add_action( 'wp_enqueue_scripts', 'properlite_home_widget_one_style' );
...
function properlite_home_widget_two_style() {
	
	$widget_column_two = esc_html( get_theme_mod( 'properlite_widget_column_two' ));
...
add_action( 'wp_enqueue_scripts', 'properlite_home_widget_two_style' );
...
function properlite_home_widget_three_style() {
	
	$widget_column_three = esc_html( get_theme_mod( 'properlite_widget_column_three' )); 
...
add_action( 'wp_enqueue_scripts', 'properlite_home_widget_three_style' );
...
function properlite_home_widget_four_style() {
	
	$widget_column_four = esc_html( get_theme_mod( 'properlite_widget_column_four' ));
...
add_action( 'wp_enqueue_scripts', 'properlite_home_widget_four_style' );
	
/*-----------------------------------------------------------------------------------------------------//
	Home Widget Five
-------------------------------------------------------------------------------------------------------*/

function properlite_home_widget_five_style() {
	
	$widget_column_five = esc_html( get_theme_mod( 'properlite_widget_column_five', '1' ));
...
add_action( 'wp_enqueue_scripts', 'properlite_home_widget_five_style' ); 